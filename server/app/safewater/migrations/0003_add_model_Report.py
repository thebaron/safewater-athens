...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Report'
        db.create_table(u'safewater_report', (
            ...
            ('pws_affected', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['safewater.PublicWaterSource'])),
        ...
        db.send_create_signal(u'safewater', ['Report'])


    def backwards(self, orm):
        # Deleting model 'Report'
        db.delete_table(u'safewater_report')
